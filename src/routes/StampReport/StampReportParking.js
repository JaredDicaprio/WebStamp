...
class StampReportParking extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    // this.props.load_stamp_report_parking();
  ...
  onsearch = e => {
    ...
    this.props.form.validateFields((err, value) => {
      if (!err) {
        ...
        this.setState({ data_send: data_parameter });
        this.props.load_stamp_report_parking(data_parameter);
      }
    });
  };
  render() {
    ...
    return (
      <div>
        ...
        <Table
          dataSource={this.props.data_stamp_report_parking}
          scroll={{ x: 1500 }}
        >
          <Column
...
const formStampReport = Form.create({ name: "formStampReportParking" })(
  StampReportParking
);
